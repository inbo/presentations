...
> - part of international research networks: LTER, LifeWatch, ALTER-net, GBIF ...
...
dataset <- frame_data(
  ...
  "Discussion", -1.2, 1.1, 0, 1, 4,
"- Interpretation results
- Scope model
- Validity of research
- Policy recommendations
- Policy tools",
  "Introduction", 0.2, 1.1,  0, 1, 1,
"- Concept
- Hypothesis
- Motivation",
...
dataset %>%
  ...
  ggplot(aes(x = X, y = Y)) +
  geom_text(aes(label = Bullets, y = Y - 0.3), hjust = 0, vjust = 1, size = 2, colour = inbo.hoofd) +
  geom_label(
...
shapes %>%
  ...
  scale_colour_manual(values = c("TRUE" = inbo.hoofd, "FALSE" = inbo.steun.blauw)) +
  coord_fixed() + 
  scale_fill_manual(values = c("TRUE" = inbo.steun.geelgroen, "FALSE" = NA)) +
  theme_blank()
```
...
shapes %>%
  ...
  scale_colour_manual(values = c("TRUE" = "white", "FALSE" = inbo.steun.blauw)) +
  coord_fixed() + 
  scale_fill_manual(values = c("TRUE" = inbo.steun.geelgroen, "FALSE" = NA)) +
  theme_blank()
```
...
shapes %>%
  ...
  scale_colour_manual(values = c("TRUE" = inbo.steun.donkerroos, "FALSE" = inbo.steun.blauw)) +
  coord_fixed() + 
  scale_fill_manual(values = c("TRUE" = inbo.steun.geelgroen, "FALSE" = NA)) +
  theme_blank()
```
...
shapes %>%
  ...
  scale_colour_manual(values = c("TRUE" = "black", "FALSE" = inbo.steun.blauw)) +
  coord_fixed() + 
  scale_fill_manual(values = c("TRUE" = inbo.steun.geelgroen, "FALSE" = NA)) +
  theme_blank()
```
